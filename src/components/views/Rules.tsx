                                        ...
                                        <TabPanel value="1">
                                            <Grid container>
                                                <Typography sx={{textAlign: "justify"}}>
                                                    ...
                                                    visually appealing, and easy to navigate. Hope you enjoy...
                                                </Typography>
                                            </Grid>
                                        </TabPanel>
                                        <TabPanel value="2">
                                        ...
                                        <TabPanel value="3">
                                            <Grid container alignItems="center">
                                                <Grid item xs={6}>
                                                    <Box>
                                                        <Typography sx={{mr: 4, textAlign: "justify"}}>
                                                            On our Join Lobby page, you have a multitude of options to
                                                            find and join a game that suits your preferences. Browse
                                                            through the server list of available games, where you can
                                                            view the number of players currently in the lobby, the
                                                            creator of the game, and its current state. To join a game,
                                                            simply click on the green join button next to the desired
                                                            lobby. Additionally, if you have a specific lobby in mind,
                                                            you can directly join it by entering the lobby ID in the
                                                            provided field at the top of the page. This seamless
                                                            experience ensures that you can quickly find and participate
                                                ...
                                                <Grid item xs={8}>
                                                    <Box>
                                                        <Typography sx={{mr: 4, textAlign: "justify"}}>
                                                            ...
                                                            you've just joined. This interactive and informative space
                                                            is divided into several sections to keep you informed and
                                                            engaged. First, you'll find a dedicated area that makes it
                                                            easy for friends to join your game, either through a QR code
                                                            or by sharing the direct lobby ID link. Second, you can keep
                                                            track of all the players who have joined the lobby,
                                                            providing an at-a-glance view of your competition. Lastly,
                                                            you can review the game settings chosen by the host,
                                                            ensuring you're familiar with the rules and format before
                                                            the game starts. If you happen to be the host, you'll have
                                                            the additional option to start the game at your discretion,
                                                            located conveniently at the bottom of the page. The Game
                                                            Lobby page is designed to bring all essential pre-game
                                                            information together, creating a seamless experience for
                                                            both hosts and players alike. </Typography>
                                                    </Box>
                                                </Grid>
                                                <Grid item xs={4}>
                                                    <img
                                                ...
                                                <Grid item xs={7}>
                                                    <Box>
                                                        <Typography sx={{mr: 4, textAlign: "justify"}}>
                                                            ...
                                                            starts ticking away at the top of the screen, accompanied by
                                                            a visual representation of the remaining time. Your mission
                                                            is to identify the country based on the hints displayed at
                                                            the center of the page. To submit your guess, simply type
                                                            the name of the country into the input field at the top of
                                                            the screen. We understand that spelling can be challenging,
                                                            especially for countries with unique or complex names. To
                                                            assist you in your quest, the input field features an
                                                            autocomplete function and provides suggestions to help you
                                                            spell the country correctly. With a combination of quick
                                                            thinking and accurate typing, you'll be on your way to
                                                            becoming a master of geographical knowledge. </Typography>
                                                    </Box>
                                                </Grid>
                                                <Grid item xs={5}>
                                                    <img
