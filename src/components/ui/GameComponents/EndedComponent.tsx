    ...
    return (
        <Container>
            ...
            >
                ...
                <Button
                    size="large"
                    sx={{marginLeft: "3%", alignContent: "center", position: "relative"}}
                    variant="outlined"
                    onClick={playAgain}
                >
                    {timeProgress > 0 && (
            ...
            >
                ...
                <AccordionDetails sx={{display: 'flex', justifyContent: 'space-between'}}>
                    <AccordionDetails>
                        <Typography variant="h6">Leaving Players</Typography>
                        <ul
                            style={{
                                display: 'flex',
                        ...
                        >
                            {playersNotPlayingAgain.map((data) => (
                                <li
                                    key={data.userId}
                                    style={{
                                        margin: '0.5rem',
                    ...
                    <AccordionDetails>
                        <Typography variant="h6">Down for another Game</Typography>
                        <ul
                            style={{
                                display: 'flex',
                                flexDirection: 'column',
