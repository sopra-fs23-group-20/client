...
const AppName = styled('h1')({
    ...
    color: "transparent",
    backgroundImage: 'linear-gradient(90deg, #F4D03F 0%, #58D68D 15%, #48C9B0 30%, #5DADE2 45%, #8E44AD 60%, #C0392B 75%, #F1C40F 90%)',
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <Box sx={{display: "flex", justifyContent: "center", marginTop: 2}}>
                        <Button
                            ...
                            type="submit"
                            sx={{backgroundColor: "primary.main", color: "primary.contrastText", marginTop: 2}}
                        >
                    ...
                    <Box sx={{display: "flex", justifyContent: "center"}}>
                        <Button
                            ...
                            sx={{backgroundColor: "primary.light", color: "primary.contrastText", marginTop: 2}}
                        >
