    ...
    <StyledDiv>
      ...
      >
        <Box sx={{ fontWeight: "500" }}>
          "Guess The Country" is the new webapp: Learn more about Countries by
          competing in fun quiz rounds. You can also learn more about countries
          by using the all new learning cards. You can challenge your friends by
          playing against them and you can see your progress by looking at the
      ...
      <Typography
        ...
        padding="1em"
      >
        <Box sx={{ fontWeight: "500" }}>If you already have an account:</Box>
      </Typography>
      <Button
        size="large"
        sx={{
