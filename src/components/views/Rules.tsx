      ...
      <div id={"full page"}>
        {isDesktop ? (
            ...
            <div id={"mobile version"}>
              ...
              <Accordion expanded={expanded === 'panel1'} onChange={handleChangemobile('panel1')}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon />}
              ...
              <Accordion expanded={expanded === 'panel2'} onChange={handleChangemobile('panel2')}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon />}
                    aria-controls="panel2bh-content"
                    id="panel2bh-header1"
                >
                  <Typography sx={{ width: '33%', flexShrink: 0 }}>Guide</Typography>
                ...
                <AccordionDetails>
                  <Typography>
                    Our project aims to create an interactive platform that makes learning geography fun, engaging, and accessible. By challenging users to identify countries based on various clues, we hope to enhance their geographic knowledge across multiple domains. With this goal in mind, we designed the project to be user-friendly, visually appealing, and easy to navigate. Have fun and good luck!
                  </Typography>
                </AccordionDetails>
              </Accordion>
              <Accordion expanded={expanded === 'panel3'} onChange={handleChangemobile('panel3')}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon />}
                ...
                <AccordionDetails>
                  <Typography>
                    On our "Create a Game" page, you have the flexibility to customize your gaming experience by setting various parameters, ensuring a unique and engaging challenge each time you play. You can determine the number of rounds, round length, and the time between rounds, tailoring the game to your preferred pace. Additionally, you can choose between different difficulty levels and game modes to suit your skill level and interests. To make the game even more captivating, you have the option to select specific regions and decide the type of hints you'd like to receive during gameplay. Finally, you can control the visibility of your lobby, opting for a public or private setting. With these diverse customization options, our "Create a Game" page empowers you to design an exciting and personalized gaming experience.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              <Accordion expanded={expanded === 'panel4'} onChange={handleChangemobile('panel4')}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon />}
                ...
                <AccordionDetails>
                  <Typography>
                    On our Join Lobby page, you have a multitude of options to find and join a game that suits your preferences. Browse through the server list of available games, where you can view the number of players currently in the lobby, the creator of the game, and its current state. To join a game, simply click on the green join button next to the desired lobby. Additionally, if you have a specific lobby in mind, you can directly join it by entering the lobby ID in the provided field at the top of the page. This seamless experience ensures that you can quickly find and participate in games tailored to your interests.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              <Accordion expanded={expanded === 'panel5'} onChange={handleChangemobile('panel5')}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon />}
                ...
                <AccordionDetails>
                  <Typography>
                    On our Game Lobby page, you enter a central hub for the game you've just joined. This interactive and informative space is divided into several sections to keep you informed and engaged. First, you'll find a dedicated area that makes it easy for friends to join your game, either through a QR code or by sharing the direct lobby ID link. Second, you can keep track of all the players who have joined the lobby, providing an at-a-glance view of your competition. Lastly, you can review the game settings chosen by the host, ensuring you're familiar with the rules and format before the game starts. If you happen to be the host, you'll have the additional option to start the game at your discretion, located conveniently at the bottom of the page. The Game Lobby page is designed to bring all essential pre-game information together, creating a seamless experience for both hosts and players alike.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              <Accordion expanded={expanded === 'panel6'} onChange={handleChangemobile('panel6')}>
                <AccordionSummary
                    expandIcon={<ExpandMoreIcon />}
                ...
                <AccordionDetails>
                  <Typography>
                    On our Game Page, the action truly begins as the countdown starts ticking away at the top of the screen, accompanied by a visual representation of the remaining time. Your mission is to identify the country based on the hints displayed at the center of the page. To submit your guess, simply type the name of the country into the input field at the top of the screen. We understand that spelling can be challenging, especially for countries with unique or complex names. To assist you in your quest, the input field features an autocomplete function and provides suggestions to help you spell the country correctly. With a combination of quick thinking and accurate typing, you'll be on your way to becoming a master of geographical knowledge.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </div>
