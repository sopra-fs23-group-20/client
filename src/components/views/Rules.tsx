            ...
            <AccordionDetails>
              <Box sx={{ width: '100%', typography: 'body1' }}>
                <TabContext value={value}>
                  ...
                  <TabPanel value="1">
                    'Guess the Coutry' is an online game, where people can play together by
                    testing their knowledge about our countries.
                  </TabPanel>
                  <TabPanel value="2">

                    <Typography>When creating a new game, you can decide, what regions should be included and the types of hints you want to receive.</Typography>
                    <img src={GameSettings} alt="GameSettings"  style={{ marginBottom: "2rem" }} />
                  </TabPanel>
                  <TabPanel value="3">
                    You can join a game by selecting one from the lobby browser and press the join button. If you received a Game Code, you insert it and join the game.
                  </TabPanel>
                  <TabPanel value="4">
                    When you joined a game you can share it the lobby, view the the joined players and the selected settings.
                    <img src={GameLobby} alt="Game Lobby" style={{ marginBottom: "2rem" }} />

                  </TabPanel>
                  <TabPanel value="5">
                    When the game starts, you have guess what country we are looking for by analyzing the given hints. If you are correct and fast, you will get the most points.
                    <img src={InTheGame} alt="The Game" style={{ marginBottom: "2rem" }} />
                  </TabPanel>
